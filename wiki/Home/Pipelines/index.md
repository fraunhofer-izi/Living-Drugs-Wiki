...
-   __:microscope: LivingDrugOmics__
    ...
    - _Supports_:
        - Optimized Nextflow pipeline compatible with 10x Genomics single-cell technologie such as gene expression (5' and 3'),  VDJ-T, VDJ-B, cell surface protein detection
        - Includes CAR-specific detection and quality control
    - _Output:_
        - Seurat object with integrated single-cell multi-omic RNA-seq data ready for downstream analysis
...
-   __:computer: Integration Site Analysis (in-progress)__
    ...
    Read more about out unbiased whole-genome based approach in our publication: [Braun et. al 2024](https://www.nature.com/articles/s41591-025-03499-9)
